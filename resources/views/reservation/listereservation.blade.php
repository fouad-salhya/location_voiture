                    ...
                    @foreach ($reservations as $reservation)
                      ...
                      <td scope="col">
                          <div class="row">
                           ...
                           <form action="{{route('confirme',$reservation->id)}}" method="POST">
                              @csrf
                              @method('PATCH')
                              <button class="btn btn-sm btn-warning">Non Confirmé</button> 
                        ...
                        @endif
                          <form action="{{route('deletereservation',$reservation->id)}}" method="POST">
                           ...
                           <a role="btn" class="btn btn-sm btn-info ml-1" href="{{route('detail_reservation',$reservation->id)}}">
